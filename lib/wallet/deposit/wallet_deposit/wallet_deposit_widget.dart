...
import 'wallet_deposit_model.dart';
export 'wallet_deposit_model.dart';

class WalletDepositWidget extends StatefulWidget {
  const WalletDepositWidget({super.key});

  @override
  State<WalletDepositWidget> createState() => _WalletDepositWidgetState();
}

class _WalletDepositWidgetState extends State<WalletDepositWidget>
    with TickerProviderStateMixin {
  late WalletDepositModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WalletDepositModel());
