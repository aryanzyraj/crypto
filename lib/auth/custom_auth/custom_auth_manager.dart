...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    bicryptoV3AuthUserSubject.add(
      BicryptoV3AuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<BicryptoV3AuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  BicryptoV3AuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = BicryptoV3AuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    bicryptoV3AuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
BicryptoV3AuthUser? currentUser;
